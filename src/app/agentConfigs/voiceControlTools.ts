...
export const switchScenarioTool = tool({
  name: 'switchScenario',
  description:
    'Switches the entire conversation to a different scenario (graffity, kate, basho, or takuboku). Use when the user explicitly requests a different experience.',
  parameters: {
    type: 'object',
    properties: {
      scenarioKey: {
        type: 'string',
        description: 'The scenario identifier to switch to (graffity, kate, basho, or takuboku).',
      },
    },
